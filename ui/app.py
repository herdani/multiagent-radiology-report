...
def process_scan(dicom_file, image_file, clinical_note: str, modality: str):
    ...
    try:
        if dicom_file is not None:
            ...
            import hashlib
            from pipeline.preprocessor import normalize_pixels
        ...
        heatmap_path = xai_result.get("heatmap_path") if xai_result.get("heatmap_path") \
            and os.path.exists(xai_result.get("heatmap_path", "")) else None
